...
const WORDS: WordData[] = [
  { word: 'ஆடு', letters: ['ஆ', 'டு'], emoji: '🐐', hint: 'Goat', color: 'bg-red-50 text-red-700 border-red-100' },
  { word: 'வீடு', letters: ['வீ', 'டு'], emoji: '🏠', hint: 'House', color: 'bg-orange-50 text-orange-700 border-orange-100' },
  { word: 'மீன்', letters: ['மீ', 'ன்'], emoji: '🐟', hint: 'Fish', color: 'bg-amber-50 text-amber-700 border-amber-100' },
  { word: 'கல்', letters: ['க', 'ல்'], emoji: '🪨', hint: 'Stone', color: 'bg-green-50 text-green-700 border-green-100' },
  { word: 'பல்', letters: ['ப', 'ல்'], emoji: '🦷', hint: 'Tooth', color: 'bg-sky-50 text-sky-700 border-sky-100' },
  { word: 'ஏடு', letters: ['ஏ', 'டு'], emoji: '📖', hint: 'Book', color: 'bg-violet-50 text-violet-700 border-violet-100' },
];

const QUESTIONS = [
  { emoji: '🐐', hint: 'Goat', target: 'ஆடு', options: ['ஆடு', 'வீடு', 'மீன்', 'கல்'] },
  { emoji: '🏠', hint: 'House', target: 'வீடு', options: ['வீடு', 'ஆடு', 'பல்', 'ஏடு'] },
  { emoji: '🐟', hint: 'Fish', target: 'மீன்', options: ['மீன்', 'கல்', 'ஏடு', 'வீடு'] },
  { emoji: '🪨', hint: 'Stone', target: 'கல்', options: ['கல்', 'பல்', 'ஆடு', 'மீன்'] },
  { emoji: '🦷', hint: 'Tooth', target: 'பல்', options: ['பல்', 'ஏடு', 'வீடு', 'கல்'] },
];

export default function TamilTwoLetterWordsQuiz({ onComplete }: Props) {
  ...
  if (done) {
    ...
    return (
      <div className="flex flex-col items-center gap-6 px-6 py-10 kids-font">
        ...
        <h2 className="text-3xl font-black text-indigo-950 text-center uppercase">ஈரெழுத்து நாயகன்!</h2>
        <p className="text-lg font-bold text-indigo-900/60 text-center -mt-2">Incredible! You learned two-letter words! 🌟</p>
    ...
    <div className="flex flex-col items-center gap-4 px-3 py-2 w-full max-w-md mx-auto kids-font select-none">
      ...
      <div className="text-center">
        <span className="text-[10px] font-black text-indigo-900/40 uppercase tracking-widest px-3 py-1 bg-indigo-50 rounded-full border border-indigo-100/50">
          📙 ஈரெழுத்துச் சொற்கள் (2-Letter Words)
        </span>
      ...
      {mode === 'learn' ? (
              ...
              <>
                <div className="flex items-center gap-3">
                  <div className="flex flex-col">
                    ...
                    <span className="text-[9px] font-black text-indigo-900/40 uppercase tracking-widest mt-1">ஈரெழுத்து சொல்</span>
                  </div>
                </div>
        ...
        <div className="w-full flex flex-col gap-4 mt-1">
          ...
          <button
            ...
            className="w-full py-2 bg-slate-100 hover:bg-slate-200 text-slate-600 rounded-2xl font-bold text-sm border active:scale-95 cursor-pointer text-center"
          >
            ⬅️ படிப்பு பலகை
          </button>
        </div>
